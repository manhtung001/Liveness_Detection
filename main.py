...
ap.add_argument("-t", "--threshold", required=False,
                help="threshold used for the classifier to decide between genuine and a spoof attack")
...
if __name__ == "__main__":
    ...
    clf = None
    try:
        clf = joblib.load('models/print-attack_ycrcb_luv_extraTreesClassifier.pkl')
    except IOError as e:
